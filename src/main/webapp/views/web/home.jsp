			...
			<div class="row gx-5 justify-content-center">
				<div class="col-lg-8 col-xl-6">
					<div class="text-center">
						<h2 class="fw-bolder">Tương quan trận Oman - Việt Nam</h2>
						<p class="lead fw-normal text-muted mb-5">Xét về đối đầu, thành tích hiện tại và hình thể, Oman đều trên cơ. Nhưng, Việt Nam rất biết cách tạo đột biến mỗi khi ở thế "cửa dưới" dưới thời HLV Park Hang-seo.</p>
					</div>
				</div>
			</div>
			<div class="row gx-5">
			...
			<aside class="bg-primary bg-gradient rounded-3 p-4 p-sm-5 mt-5">
				<div
					...
					<div class="mb-4 mb-xl-0">
						<div class="fs-3 fw-bold text-white">New products, delivered
							to you.</div>
